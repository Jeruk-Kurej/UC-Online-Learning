<x-app-layout>
    ...
    <div style="max-width: 1200px; margin: 40px auto; padding: 0 25px; font-family: 'Inter', -apple-system, sans-serif; color: #1e293b;" 
        ...
        {{-- Tabs Selector --}}
        <div style="display: flex; gap: 8px; border-bottom: 2px solid #f1f5f9; margin-bottom: 30px; padding-bottom: 2px;">
            <button @click="activeTab = 'messages'" 
                    :style="activeTab === 'messages' ? 'border-bottom: 3px solid #f97316; color: #0f172a; font-weight: 800;' : 'color: #64748b; font-weight: 600;'"
                    style="padding: 12px 18px; font-size: 14px; border: none; background: transparent; cursor: pointer; transition: 0.2s; outline: none; margin-bottom: -3px;">
                <i class="bi bi-chat-left-text-fill mr-2"></i>Inbox & Invitations
            </button>
            <button @click="activeTab = 'sent'" 
                    ...
                    style="padding: 12px 18px; font-size: 14px; border: none; background: transparent; cursor: pointer; transition: 0.2s; outline: none; margin-bottom: -3px;">
                <i class="bi bi-send-fill mr-2"></i>Sent Requests
            </button>
            <button @click="activeTab = 'connections'" 
                    ...
                    style="padding: 12px 18px; font-size: 14px; border: none; background: transparent; cursor: pointer; transition: 0.2s; outline: none; margin-bottom: -3px;">
                <i class="bi bi-people-fill mr-2"></i>My Network
            </button>
        </div>
