            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="student_status" id="student_status" required class="block w-full">
                        <option value="active" {{ old('student_status', $userToEdit->student_status) === 'active' ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ old('student_status', $userToEdit->student_status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                        <option value="cuti" {{ old('student_status', $userToEdit->student_status) === 'cuti' ? 'selected' : '' }}>Cuti</option>
                        <option value="alumni" {{ old('student_status', $userToEdit->student_status) === 'alumni' ? 'selected' : '' }}>Alumni</option>
                    </select>
