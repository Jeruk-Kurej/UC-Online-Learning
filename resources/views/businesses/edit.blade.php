            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3" required
                              class="block w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-soft-gray-900 focus:border-soft-gray-900">{{ old('description', $business->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="province" id="province" class="block w-full">
                        ...
                        @foreach($availableProvinces as $prov)
                            <option value="{{ $prov }}" {{ old('province', $business->province) === $prov ? 'selected' : '' }}>{{ $prov }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="city" id="city" class="block w-full">
                        ...
                        @foreach($availableCities as $c)
                            <option value="{{ $c }}" {{ old('city', $business->city) === $c ? 'selected' : '' }}>{{ $c }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="2"
                              class="block w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-soft-gray-900 focus:border-soft-gray-900">{{ old('address', $business->address) }}</textarea>
                </div>
